...
You can find the new tenant setting in the [Auth0 Dashboard Advanced Tenant Settings](${manage_url}/#/tenant/advanced) page. Scroll to locate the **Migrations** section, and you will see **Default to 'Email Verification' setting for Azure AD/ADFS connections**.
